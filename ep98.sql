...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('98',     
                     'Electronic circuit boards, part one of N.' ,
                     'We only have 134 of these to do, how long could it possibly take?');
...
from (select * from recipeTarget where item = 'advanced-circuit' and craftingName = 'Electronics assembling machine 2' and targetName = 'Red Belt 2 side') r1
LEFT OUTER JOIN (select * from recipeTarget where craftingName = 'Electronics assembling machine 2' and targetName = '1 per Second') r2 on (r1.constituentItem = r2.item)
