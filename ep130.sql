...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('130',     
                     'Blue science!' ,
                     'Oh boy oh boy oh boy. Only 3 days late.');
...
from (select * from recipeTarget where item = 'science-pack-2' and craftingName = 'Assembling machine 3' and targetName = 'Yellow Belt 1 side') r1
