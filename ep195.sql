...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('196',     
                     'Finishing logic boards',
                     'With maybe a brief stop at the mall for bearings...');
...
from (select * from recipeTarget where recipe = 'processing-unit' and craftingName = 'Electronics assembling machine 3 w 6 Speed 1' and targetName = 'Red Belt 2 side') r1
...
where r2.recipe IN ('superior-circuit-board')
