...
from (select * from recipeTarget where recipe = 'angels-plate-tungsten' and craftingName = 'Assembling machine 5 w 5 raw speed 2' and targetName = 'Red Belt 2 side') r1
