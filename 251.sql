...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('251',     
                     'Redoing plastic',
                     'I am a silly silly person. Silly. Silly. Person.');
...
from (select * from recipeTarget where recipe = 'basic-electronic-components' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
...
--where r3.recipe  IN ('carbon-separation-2')
