...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('255',     
                     'Modules, again again',
                     'This time aiming for higher levels.');
...
from (select * from recipeTarget where recipe = 'speed-processor-2' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
