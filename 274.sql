...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '386.5' and targetName = '1 per Second') r2 on (r1.constituentItem = r2.item)
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '227.5' and targetName = '1 per Second') r3 on (r2.constituentItem = r3.item)
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '266.7' and targetName = '1 per Second') r4 on (r3.constituentItem = r4.item)
...
where r2.recipe IN ('rocket-fuel') --IN ('rocket-control-unit')
