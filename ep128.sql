...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('128',     
                     ...
                     'Time to make a full red belt of battery');
...
from (select * from recipeTarget where item = 'battery' and craftingName = 'Chemical Plant' and targetName = 'Red Belt 2 side') r1
