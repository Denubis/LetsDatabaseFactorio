...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('131',     
                     'Okay, maybe not quite blue science!' ,
                     'I must be minded to temper enthusiasm');
...
from (select * from recipeTarget where item = 'science-pack-3' and craftingName = 'Assembling machine 3' and targetName = 'Yellow Belt 1 side') r1
