...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('120',     
                     'Basic circuits redux... again' ,
                     'This would be easier with better belts.');
...
from (select * from recipeTarget where item = 'science-pack-1' and craftingName = 'Assembling machine 3' and targetName = 'Red Belt 1 side') r1
