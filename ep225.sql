...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('225',     
                     'More Tungsten and Robot prep',
                     'At least some prep and some tungsten. Probably.');
...
from (select * from recipeTarget where recipe = 'bob-tungsten-plate' and craftingName = 'Electric Multi-Purpose w 5 Raw Speed 2' and targetName = 'Purple Belt 2 side') r1
