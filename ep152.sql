...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('152',     
                     'First steps towards advanced metals' ,
                     'The long road to titanium and aluminium.');
...
from (select * from recipeTarget where recipe = 'angels-plate-aluminium' and craftingName = 'Casting Machine MK2' and targetName = 'Red Belt 2 side') r1
...
where r2.recipe IN ('molten-aluminium-smelting-1')
