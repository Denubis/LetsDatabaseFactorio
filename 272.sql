...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('272',     
                     'Working on Hydrazine',
                     'Oh this will be fiddly.
                     ');
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '202.5' and targetName = '1 per Second') r6 on (r5.constituentItem = r6.item)
...
and r5.recipe not in ('gas-ammonia')
and r6.recipe in ('salt-water-electrolysis-2')
