...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('207',     
                     'Other module circuit boards',
                     'Now that we have a working design, time to duplicate it.');
...
from (select * from recipeTarget where recipe = 'effectivity-processor' and craftingName = 'Electronics assembling machine 3 w 6 Speed 1' and targetName = 'Purple Belt 2 side') r1
