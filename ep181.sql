...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('181',     
                     'Brass and Invar',
                     'Step 4, Realise you have no titanium.');
...
from (select * from recipeTarget where recipe = 'angels-plate-nickel' and craftingName = 'Casting Machine MK3 w 2 Speed Module' and targetName = 'Red Belt 2 side') r1
