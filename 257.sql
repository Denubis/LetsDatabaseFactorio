...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('257',     
                     'Building Iron Man - Power Armor Mk 5',
...
from (select * from recipeTarget where recipe = 'speed-processor-3' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
