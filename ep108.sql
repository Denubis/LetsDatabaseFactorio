...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('108',     
                     'Tin and maybe Iron' ,
                     'Did some more pre-game prep moving loading factories around.');
...
from (select * from recipeTarget where recipe = 'angelsore-crushed-mix2-processing' and craftingName = 'Ore Processing Machine MK2' and targetName = 'Red Belt 2 side') r1
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = 'Assembling machine 3' and targetName = '1 per Second') r4 on (r3.constituentItem = r4.item)
