...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('119',     
                     ...
                     'Making the wheel better. faster. stronger.');
...
from (select * from recipeTarget where item = 'electronic-circuit' and craftingName = 'Electronics assembling machine 2' and targetName = 'Red Belt 2 side') r1
