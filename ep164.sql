...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('164',     
                     'On track for Atomic Trains' ,
                     'Marvel at these... trains of the future....');
...
from (select * from recipeTarget where recipe = 'engine-unit' and craftingName = 'C1 with 3 Speed 1' and targetName = '1 per Second') r1
