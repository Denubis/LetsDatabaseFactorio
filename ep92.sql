...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('92',     
                     'Rebuilding copper.' ,
                     'One step forward, two rather complex queries backwards');
...
from (select * from recipeTarget where item = 'copper-plate' and recipe like '%angel%' and craftingName = 'Casting Machine MK2' and targetName = 'Red Belt 2 side') r1
