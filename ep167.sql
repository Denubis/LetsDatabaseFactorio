...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('167',     
                     'Maybe actually an Atomic Train?' ,
                     'Let us see what else I have forgotten. I forget.');
...
from (select * from recipeTarget where recipe = 'electric-engine-unit' and craftingName = 'Assembling machine 3' and targetName = '1 per Second') r1
...
where r3.recipe IN ('iron-gear-wheel', 'iron-pipe')
