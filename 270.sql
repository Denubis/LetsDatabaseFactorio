...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('270',     
                     'Advanced Chemical Plants and Algae Farms',
                     'Continuing pre-rocket prep with stone recylcing.
                     ');
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = 'Row 8 Assembling machine 6 w 4x raw speed 8 Beacon' and targetName = '1 per Second') r2 on (r1.constituentItem = r2.item)
...
where r2.recipe NOT IN ('rocket-fuel')
