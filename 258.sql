...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('258',     
                     ...
                     'Starting on *proper* module infrastructure...');
...
from (select * from recipeTarget where recipe = 'raw-speed-module-8' and craftingName = 'Assembling machine 6 w 6 raw speed 8' and targetName = '1 per Second') r1
...
where r7.recipe  IN ('raw-speed-module-2')
