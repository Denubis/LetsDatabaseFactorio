...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('180',     
                     'Faster Underground and splitter!',
                     'Step 3, do it again, for twice the price.');
...
from (select * from recipeTarget where recipe = 'green-transport-belt' and craftingName = 'C1 with 3 Speed 1' and targetName = 'Yellow Belt 1 side') r1
...
where r4.recipe IN ('transport-belt')
