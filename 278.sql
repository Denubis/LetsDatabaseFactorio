...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('278',     
                     'Finale - Organic Rocket',
                     'Launching a rocket fuelled with... stone. Just... stone.');
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '171.5' and targetName = '1 per Second') r5 on (r4.constituentItem = r5.item)
...
and r5.recipe in ('gas-methylamine')
and r6.recipe in ('gas-ammonia')
