...
from (select * from recipeTarget where item = 'basic-circuit-board' and craftingName = 'Electronics assembling machine 2' and targetName = 'Red Belt 2 side') r1
