...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('96',     
                     'More vitamins.' ,
                     'Basic electronic components and transistors...');
...
from (select * from recipeTarget where item = 'basic-electronic-components' and craftingName = 'Electronics assembling machine 1' and targetName = 'Red Belt 2 side') r1
