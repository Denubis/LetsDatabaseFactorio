...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('185',     
                     'Lubricant. My kingdom for Lubricant',
                     'For belts and bearings, of course. What did you think I meant?');
...
from (select * from recipeTarget where recipe = 'inva-alloy' and craftingName = 'Casting Machine MK3 w 2 Speed Module' and targetName = 'Red Belt 2 side') r1
