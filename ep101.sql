...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('101',     
                     'Crystal Slurry into Copper and Tin' ,
                     'Let us use this slurry for something productive?');
...
from (select * from recipeTarget where item = 'y-refined-yres2' and craftingName = 'Electronics assembling machine 2' and targetName = 'Red Belt 2 side') r1
