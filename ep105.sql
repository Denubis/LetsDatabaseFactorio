...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('105',     
                     'Building out loaders and more automated trains' ,
                     'Eeeee! The fruits of electronic circuits');
...
from (select * from recipeTarget where item = 'fast-loader' and craftingName = 'Assembling machine 3' and targetName = '1 per Second') r1
