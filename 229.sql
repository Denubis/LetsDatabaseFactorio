...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('229',     
                     'More CPU layout fun.',
                     'It looks like most of the prep is elsewhere, right? Right?');
...
from (select * from recipeTarget where recipe = 'processing-electronics' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
...
where r2.recipe IN ('silicon-wafer')
