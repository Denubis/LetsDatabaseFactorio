...
from (select * from recipeTarget where recipe = 'electronic-components' and craftingName = 'Electronics assembling machine 3 w 6 Speed 1' and targetName = 'Purple Belt 2 side') r1
