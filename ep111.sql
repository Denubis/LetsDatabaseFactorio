...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('111',     
                     'Experimenting with a barrel loop' ,
                     'This is an extremely silly choice...');
...
from (select * from recipeTarget where recipe = 'angels-plate-steel' and craftingName = 'Casting Machine MK2' and targetName = 'Red Belt 2 side') r1
