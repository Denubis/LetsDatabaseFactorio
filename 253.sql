...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('253',     
                     'Electronics supplies and module prep',
                     'Time to expand our electronic supplies again.');
...
from (select * from recipeTarget where recipe = 'electronic-components' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
