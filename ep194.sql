...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('194',     
                     'Making a secondary depot',
                     'Cleaned up train logs, it''s clear we need a secondary depot blueprint.');
...
from (select * from recipeTarget where recipe = 'intergrated-electronics' and craftingName = 'Ore Processing Machine MK4' and targetName = 'Red Belt 2 side') r1
...
where r2.recipe IN ('tinned-copper-cable')
