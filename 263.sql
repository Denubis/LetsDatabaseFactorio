...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('263',     
                     'More mining updating',
                     'About halfway done with green modules and level 5 miners.');
...
from (select * from recipeTarget where recipe = 'speed-module-8' and craftingName = 'Assembling machine 6 w 6 raw speed 8' and targetName = '1 per Second') r1
LEFT OUTER JOIN (select * from recipeTarget where craftingName = 'Assembling machine 6 w 6 raw speed 8' and targetName = '1 per Second') r2 on (r1.constituentItem = r2.item)
LEFT OUTER JOIN (select * from recipeTarget where craftingName = 'Assembling machine 6 w 6 raw speed 8' and targetName = '1 per Second') r3 on (r2.constituentItem = r3.item)
...
where r7.recipe  IN ('speed-module-2')
