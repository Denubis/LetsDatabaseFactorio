...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('210',     
                     'Preparing for Raw Speed Modules',
                     'Whee, raaaaawwww speeeeeed.');
...
from (select * from recipeTarget where recipe = 'raw-speed-module-8' and craftingName = 'Electronics assembling machine 3 w 6 Speed 1' and targetName = '1 per Second') r1
