...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('213',     
                     'Lithiom Ion batteries',
                     'Oh no, back into Angel''s petrochem. Why. Why. WHY?');
...
from (select * from recipeTarget where recipe = 'lithium-ion-battery' and craftingName = 'Assembling machine 5 w 5 raw speed 2' and targetName = 'Red Belt 2 side') r1
...
where r2.recipe IN ('lithium-perchlorate','lithium-cobalt-oxide')
