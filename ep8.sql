...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
	         VALUES('8', 	   'After the termites', 'Laying smelters.');
...
REPLACE INTO todolist ( ListID, 	EpisodeID, 	Title,			
						todoDescription)
				VALUES(	9, 			8,			'Basic ore smelting.', 		
						'Get basic ore smelting going.')
					  ;	

REPLACE INTO todolistState(listid) VALUES(9);
...
REPLACE INTO craftingMachine (craftingName, electricConsumption, drain, craftingSpeed)
 	 VALUES 			    ('Stone Furnace', null, null, 1);
...
SELECT item, 
  ...
  FROM (SELECT recipe.item,
	     ...
	     WHERE craftingMachine.craftingName = 'Stone Furnace')
