...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
	            VALUES('14', 	   '... 48 celluse factories', 'I can''t find an error in my math. Owie.');
...
select primaryRecipe.item
     ...
     , primaryRecipe.constituentTotalItemAmountPerSecond 
       * secondaryRecipe.numCraftingMachines as secondaryCraftingMachines
     , tertiaryRecipe.item
     , primaryRecipe.constituentTotalItemAmountPerSecond
       * secondaryRecipe.numCraftingMachines
       * secondaryRecipe.constituentTotalItemAmountPerSecond
       * tertiaryRecipe.numCraftingMachines as tertiaryCraftingMachines
     , quaternaryRecipe.item
     , primaryRecipe.constituentTotalItemAmountPerSecond
       * secondaryRecipe.numCraftingMachines
       * secondaryRecipe.constituentTotalItemAmountPerSecond
       * tertiaryRecipe.numCraftingMachines 
       * tertiaryRecipe.constituentTotalItemAmountPerSecond
       * quaternaryRecipe.numCraftingMachines 
     as quaternaryCraftingMachines
  ...
  left outer join recipeTarget as quaternaryRecipe  on (tertiaryRecipe.constituentItem = quaternaryRecipe.item)
  where primaryRecipe.item = 'Wood Bricks'
    ...
    and quaternaryRecipe.targetName = '1 per Second'
    and quaternaryRecipe.craftingName = 'Assembling machine 1';
