...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('209',     
                     'Module Research',
                     'Starting Bob''s module research.');
...
from (select * from recipeTarget where recipe = 'module-case' and craftingName = 'Electronics assembling machine 3 w 6 Speed 1' and targetName = 'Purple Belt 2 side') r1
