...
from (select * from recipeTarget where recipe = 'angels-solder' and craftingName = 'Angels MK4 w 2 Raw Speed 8' and targetName = 'Purple Belt 2 side') r1
...
where r2.recipe  IN ('angels-solder-smelting-1')
