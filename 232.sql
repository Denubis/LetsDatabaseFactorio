...
from (select * from recipeTarget where recipe = 'advanced-processing-unit' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
...
where r2.recipe IN ('multi-layer-circuit-board')
