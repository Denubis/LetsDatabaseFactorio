...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('230',     
                     'Starting blue (bleu?) circuits.',
                     'Oh goodie gumdrops. Another circuit line.');
...
from (select * from recipeTarget where recipe = 'advanced-circuit' and craftingName = 'Electronics assembling machine 3 w 6 Raw speed 2' and targetName = 'Purple Belt 2 side') r1
...
where r2.recipe IN ('circuit-board')
