...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('273',     
                     'Am-noooo-nia',
                     'Let us see how many of these we will need.
                     ');
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '266.7' and targetName = '1 per Second') r5 on (r4.constituentItem = r5.item)
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '300.3' and targetName = '1 per Second') r6 on (r5.constituentItem = r6.item)
...
and r3.recipe in ('gas-hydrazine')
and r4.recipe IN ('gas-monochloramine')
and r5.recipe in ('gas-ammonia')
and r6.recipe in ('air-separation')
