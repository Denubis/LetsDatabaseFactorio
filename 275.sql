...
REPLACE INTO Episode(EpisodeID, EpisodeName, Description) 
              VALUES('275',     
                     'Algal stations 1',
                     'Time to build out algae processing properly.');
...
LEFT OUTER JOIN (select * from recipeTarget where craftingName = '238.7' and targetName = '1 per Second') r4 on (r3.constituentItem = r4.item)
